...
SOURCE_ITEMS=("SKILL.md" "agents" "scripts" "references" "assets")

usage() {
  cat <<'EOF'
Install the forge skill into Codex, Claude, or both.
...
Next:
  Codex : start a new session, then invoke with \$forge
  Claude: start a new session, then invoke with /forge
EOF
